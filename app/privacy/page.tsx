      ...
      <div className="max-w-4xl mx-auto bg-[#121324] border border-white/5 rounded-2xl p-8 md:p-12 shadow-2xl">
        ...
        <div className="space-y-8 leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-4 text-justify">We collect information from and about users of our Services:</p>
            <ul className="list-disc pl-5 space-y-2 mb-6 text-slate-400 text-justify">
            ...
            <p className="mb-4 text-justify">When you download, register with, or use our Services, we may ask you provide information that identifies, is linked, or is reasonably linkable to you, your household, or any other natural person, which we refer to as “personal information.”</p>
            <p className="mb-4 text-justify">The personal information we collect includes:</p>
            <ul className="list-disc pl-5 space-y-2 mb-4 text-slate-400 text-justify">
            ...
            <p className="mb-6 text-justify">You may also provide information by creating and recording content through our Services ("User Creations"), which may be linkable to you.</p>

            <h3 className="text-lg font-bold text-white mb-2">Information We Collect Through Automatic Data Collection Technologies</h3>
            <p className="mb-4 text-justify">When you download, access, and use the App, it may use technology to automatically collect the following types of personal information:</p>
            <ul className="list-disc pl-5 space-y-2 mb-4 text-slate-400 text-justify">
          ...
          <section>
            ...
            <p className="mb-2 text-justify">To ask questions or comment about this privacy policy and our privacy practices, contact us at:</p>
