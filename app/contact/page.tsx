  ...
  return (
    <main className="min-h-screen bg-[#0b0c1e] text-slate-300 font-sans p-6 md:p-12 selection:bg-pink-500 selection:text-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        ...
        <p className="text-slate-400 text-center max-w-md mb-8 text-justify">If you are experiencing issues with the ClawLive simulator, have billing questions, or just want to provide feedback, please reach out to our support team directly via email.</p>
